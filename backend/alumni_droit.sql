...
DROP TABLE IF EXISTS `alumni_droit`.`user` ;
DROP TABLE IF EXISTS `alumni_droit`.`profile_diplome` ;
DROP TABLE IF EXISTS `alumni_droit`.`profile_profession` ;
DROP TABLE IF EXISTS `alumni_droit`.`diplome` ;
DROP TABLE IF EXISTS `alumni_droit`.`master` ;
DROP TABLE IF EXISTS `alumni_droit`.`profile` ;
DROP TABLE IF EXISTS `alumni_droit`.`profession` ;

-- -----------------------------------------------------
-- Table `alumni_droit`.`user`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `alumni_droit`.`user` (
...
-- -----------------------------------------------------
-- Table `alumni_droit`.`profile_diplome`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `alumni_droit`.`profile_diplome` (
...
-- -----------------------------------------------------
-- Table `alumni_droit`.`profile_profession`
-- -----------------------------------------------------


CREATE TABLE IF NOT EXISTS `alumni_droit`.`profile_profession` (
  `profile_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `alumni_droit`.`master`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `alumni_droit`.`master` ;

CREATE TABLE IF NOT EXISTS `alumni_droit`.`master` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `profile_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `alumni_droit`.`profile`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `alumni_droit`.`profile` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_profile_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `alumni_droit`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Data for table `alumni_droit`.`user`
-- -----------------------------------------------------
START TRANSACTION;
USE `alumni_droit`;
...
-- -----------------------------------------------------
-- Data for table `alumni_droit`.`profession`
-- -----------------------------------------------------
START TRANSACTION;
USE `alumni_droit`;
...
-- -----------------------------------------------------
-- Data for table `alumni_droit`.`diplome`
-- -----------------------------------------------------
START TRANSACTION;
USE `alumni_droit`;
...
-- -----------------------------------------------------
-- Data for table `alumni_droit`.`profile`
-- -----------------------------------------------------
START TRANSACTION;
USE `alumni_droit`;
...
-- -----------------------------------------------------
-- Data for table `alumni_droit`.`profile_diplome`
-- -----------------------------------------------------
START TRANSACTION;
USE `alumni_droit`;
INSERT INTO `alumni_droit`.`profile_diplome` (`profile_id`, `diplome_id`, `year`) VALUES (1, 1, 2015);
INSERT INTO `alumni_droit`.`profile_diplome` (`profile_id`, `diplome_id`, `year`) VALUES (1, 2, 2016);
INSERT INTO `alumni_droit`.`profile_diplome` (`profile_id`, `diplome_id`, `year`) VALUES (2, 1, 2018);
INSERT INTO `alumni_droit`.`profile_diplome` (`profile_id`, `diplome_id`, `year`) VALUES (2, 3, 2020);
INSERT INTO `alumni_droit`.`profile_diplome` (`profile_id`, `diplome_id`, `year`) VALUES (3, 1, 2018);
INSERT INTO `alumni_droit`.`profile_diplome` (`profile_id`, `diplome_id`, `year`) VALUES (3, 3, 2020);
INSERT INTO `alumni_droit`.`profile_diplome` (`profile_id`, `diplome_id`, `year`) VALUES (4, 1, 2018);
INSERT INTO `alumni_droit`.`profile_diplome` (`profile_id`, `diplome_id`, `year`) VALUES (4, 2, 2019);
INSERT INTO `alumni_droit`.`profile_diplome` (`profile_id`, `diplome_id`, `year`) VALUES (4, 3, 2020);
INSERT INTO `alumni_droit`.`profile_diplome` (`profile_id`, `diplome_id`, `year`) VALUES (5, 1, 2012);
INSERT INTO `alumni_droit`.`profile_diplome` (`profile_id`, `diplome_id`, `year`) VALUES (5, 3, 2014);
INSERT INTO `alumni_droit`.`profile_diplome` (`profile_id`, `diplome_id`, `year`) VALUES (6, 1, 2015);

COMMIT;


-- -----------------------------------------------------
-- Data for table `alumni_droit`.`master`
-- -----------------------------------------------------
START TRANSACTION;
USE `alumni_droit`;
INSERT INTO `alumni_droit`.`master` (`profile_id`, `title`, `year`, `university`) VALUES (1, 'Master 2 DPG', 2017, 'Université Paris Panthéon-Assas');
INSERT INTO `alumni_droit`.`master` (`profile_id`, `title`, `year`, `university`) VALUES (2, 'Master 2 DPG', 2020, 'Université Paris Panthéon-Assas');
INSERT INTO `alumni_droit`.`master` (`profile_id`, `title`, `year`, `university`) VALUES (3, 'Master 2 DPE', 2020, 'Université Paris Panthéon-Assas');
INSERT INTO `alumni_droit`.`master` (`profile_id`, `title`, `year`, `university`) VALUES (3, 'Master 2 PLAI', 2021, 'Université Paris Panthéon-Assas');
INSERT INTO `alumni_droit`.`master` (`profile_id`, `title`, `year`, `university`) VALUES (4, 'Master 2 Droit pénal et sciences pénales', 2020, 'Université Paris Panthéon-Assas');
INSERT INTO `alumni_droit`.`master` (`profile_id`, `title`, `year`, `university`) VALUES (5, 'Master 2 PLAI', 2014, 'Université Paris Panthéon-Assas');
INSERT INTO `alumni_droit`.`master` (`profile_id`, `title`, `year`, `university`) VALUES (6, 'Master 2 DPG', 2017, 'Université Paris Panthéon-Assas');
INSERT INTO `alumni_droit`.`master` (`profile_id`, `title`, `year`, `university`) VALUES (6, 'Master 2 PLAI', 2018, 'Université Paris Panthéon-Assas');
