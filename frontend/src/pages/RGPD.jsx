  ...
  return (
    <div>
      ...
      <p className="w-[90%] text-gray-400 text-xs mx-auto my-4">
        ...
        cdd.edd.paris2@gmail.com pour faire supprimer leur profil.
      </p>

      <p className="w-[90%] text-gray-400 text-xs mx-auto my-4">
        L’Association du Collège et de l’Ecole de droit
        (cdd.edd.paris2@gmail.com) se réserve la possibilité d’utiliser les
        informations disponibles sur le site de l’annuaire, aux fins de tenir
        une liste à jour des alumni du Collège et de l’Ecole de droit et
        d’établir des statistiques sur l’insertion professionnelle des diplômés
        du Collège et de l’Ecole de droit de l’Université Paris Panthéon-Assas.
        La base légale du traitement est l’intérêt légitime de l’Association du
        Collège et de l’Ecole de droit.
      </p>
      ...
      <p className="w-[90%] text-gray-400 text-xs mx-auto my-4">
        ...
        données. Consultez le site www.cnil.fr pour plus d’informations sur vos
        droits.
      </p>
      ...
      <p className="w-[90%] text-gray-400 text-xs mx-auto my-4">
        ...
        de l’Association ou son adjoint à l’adresse cdd.edd.paris2@gmail.com. Si
        vous estimez, après nous avoir contactés, que vos droits « Informatique
        et Libertés » ne sont pas respectés, vous pouvez adresser une
